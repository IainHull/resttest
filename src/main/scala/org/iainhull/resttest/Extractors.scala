...
trait Extractors {
  ...
  type ExtractorLike[+A] = Extractors.Impl.ExtractorLike[A]

  type Extractor[+A] = Extractors.Impl.Extractor[A]
  val Extractor = Extractors.Impl.Extractor

  type Header = Extractors.Impl.Header
  val Header = Extractors.Impl.Header
